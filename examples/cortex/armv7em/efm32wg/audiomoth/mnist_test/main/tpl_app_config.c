...
/* Task mnist identifier */
#define mnist_id 0
CONST(TaskType, AUTOMATIC) mnist = mnist_id;
 ...
 */
/*-----------------------------------------------------------------------------
 * Task mnist descriptor
 */
#define APP_Task_mnist_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task mnist function prototype
 */

FUNC(void, OS_APPL_CODE) mnist_function(void);
 ...
 * Task mnist stack
 */
#define APP_Task_mnist_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) mnist_stack_zone[2000/sizeof(tpl_stack_word)];
#define APP_Task_mnist_STOP_SEC_STACK
#include "tpl_memmap.h"

#define mnist_STACK {mnist_stack_zone, 2000}
...
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_core_context, OS_VAR) mnist_int_context;

#define mnist_CONTEXT &mnist_int_context
...
/*
 * Static descriptor of task mnist
 */
CONST(tpl_proc_static, OS_CONST) mnist_task_stat_desc = {
  /* context                  */  mnist_CONTEXT,
  /* stack                    */  mnist_STACK,
  /* entry point (function)   */  mnist_function,
  /* internal ressource       */  NULL,
  /* task id                  */  mnist_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task mnist
 */
VAR(tpl_proc, OS_VAR) mnist_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
