...
#define APP_Task_cifar_main_START_SEC_LEA_VAR_LEA_16BIT
#include "tpl_memmap.h"
// DSPLIB_DATA(MULTIPLY_BUFFER, 4);
VAR(dtype, AUTOMATIC) MULTIPLY_BUFFER[LEA_RAM_LENGTH];
#define APP_Task_cifar_main_STOP_SEC_LEA_VAR_LEA_16BIT
#include "tpl_memmap.h"
